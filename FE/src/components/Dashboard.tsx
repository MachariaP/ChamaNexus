...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      {/* Header */}
      <header className="glass-effect shadow-soft border-b border-gray-200/50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                ChamaNexus Dashboard
              </h1>
            </div>
            
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-3 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl">
              ...
              <motion.button
                ...
                className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-6 py-2.5 rounded-xl font-medium hover:from-red-600 hover:to-pink-600 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Logout
              </motion.button>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div 
          ...
          className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-8 text-white mb-8 shadow-xl"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div 
              ...
              className="bg-white rounded-2xl p-6 shadow-soft border border-gray-200/50"
            >
